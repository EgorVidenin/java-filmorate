...
public class RepositoryTest {
    ...
    @Test
    public void tests() {
        FilmDbStorage repository = new FilmDbStorage(template);
        ...
        UserDbStorage userRepository = new UserDbStorage(template);
    ...
    private List<Film> make3Films(FilmDbStorage filmRepository) {
        Film film1 = new Film()
                .setId(1)
                .setName("movie 1")
    ...
    private List<User> make3Users(UserDbStorage userRepository) {
        User user1 = new User()
                .setName("Антошка")
                .setLogin("antoshka")
                .setBirthday(LocalDate.of(2000, 11, 1))
